package FizzyClubMods.WorldGen.Feature;
...
public class FizzyClubModNetherGenMinable extends WorldGenerator
{
    ...
    public FizzyClubModNetherGenMinable(int par1, int par2)
    {
        this(par1, par2, Block.netherrack.blockID);
    }

    public FizzyClubModNetherGenMinable(int par1, int par2, int par3)
    {
    ...
    public FizzyClubModNetherGenMinable(int id, int meta, int number, int target)
    {
